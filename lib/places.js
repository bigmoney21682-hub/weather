...
// There was a `nearestCity` here that named an offshore point by the nearest
// city/town/village via Overpass. It was removed: the query needed 12-17s
// against a 12s timeout with no retry, so it failed on essentially every
// production request, and the backup endpoint answers 504. The surf section now
// names those points off the beach list instead, which costs no extra call.
